    ...
    <div className="fixed top-0 left-0 w-full z-50 backdrop-blur-xs bg-white/30">
        <div className="flex  md:justify-around justify-between md:mx-0 mx-3 items-center  py-4">
            ...
            <div className="flex space-x-2 items-center text-gray-700 text-l md:text-2xl">
               <svg width="34px" height="34px" viewBox="0 0 24 24" stroke-width="1.5" fill="none" xmlns="http://www.w3.org/2000/svg" color="#ff810a"><path fill-rule="evenodd" clip-rule="evenodd" d="M4 4.25C2.48122 4.25 1.25 5.48122 1.25 7V17C1.25 18.5188 2.48122 19.75 4 19.75H20C21.5188 19.75 22.75 18.5188 22.75 17V9.75H6C5.58579 9.75 5.25 9.41421 5.25 9C5.25 8.58579 5.58579 8.25 6 8.25H22.75V7C22.75 5.48122 21.5188 4.25 20 4.25H4Z" fill="#ff810a"></path></svg>
